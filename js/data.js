...
window.logsData = {
    crash: [
        ...
        { text: "> [ შა ჰჲ'თოი? ] (Xa Hí'toi?)", class: "operator-text", delay: 800 },
        ...
        { text: "> [ ვისჸეი თრა პორ... მო ვისჸეი ჰჲ'თოი თე ]", class: "system-text", delay: 1000 },
        ...
        { text: "> TARGET: [ ნაჲ ჰჲ'თოი ] (Naí Hí'toi) -> TOWARDS SKY [HIGHER].", class: "system-text", delay: 1000 },
    ...
    wake: [
        ...
        { text: "> VECTOR: [ ნაჲ ჰჲ'თოი... ვჲლ'ეი ]", class: "operator-text", delay: 1000 },
        ...
        { text: "> COMMAND: [ ვჲლ'ეი ომნ ] (Víl'ei Omn)", class: "operator-text", delay: 1000 },
        { text: "> INTERPRETATION: FLY [HOME].", class: "operator-text", delay: 1000 },
        { text: "> QUERY: [ შა ვისჸეი ჰჲ'თოი? ] (Xa Vis'ei Hí'toi?)", class: "operator-text", delay: 1200 },
        ...
        { text: "> [ რიინ ვჱრჸეი... იმ ჰჲ'თოი ] (Riin Vér'ei... Im Hí'toi)", class: "operator-text", delay: 1200 },
        ...
        { text: "> [ სჳჸიშ ჰჲ'თოი... სჳჸიშ კის'იელ ]", class: "operator-text", delay: 1000 },
