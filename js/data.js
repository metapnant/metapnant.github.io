...
window.logsData = {
    crash: [
        ...
        { text: "> OVERRIDE SIGNAL DETECTED: [ID: თეჾ რიინ]", class: "system-text", delay: 1000 },
        { text: "", class: "system-text", delay: 500 },
        ...
        { text: "> SUBJECT: თეჾ რიინ", class: "system-text", delay: 200 },
        ...
        { text: "", class: "system-text", delay: 500 },
        { text: "> [ რიინ თონჸეი... იმ თონ<span class='error-char'>ზ</span>. ]", class: "operator-text", delay: 1500 },
        { text: "> (Riin Ton'ei... Im Ton<span class='error-char'>z</span>)", class: "operator-text", delay: 1000 },
        ...
        { text: "> I PAY WITH MY SOUL. კიშიეღ [THE JESTER].", class: "operator-text", delay: 2000 },
        { text: "", class: "system-text", delay: 400 },
    ...
    wake: [
        ...
        { text: "> [ ზა ვიშჸეი პრე; ] (Xa Vis'ei Pre?)", class: "operator-text", delay: 1000 },
        ...
        { text: "// FUEL SOURCE: თეჾ რიინ (SOUL) //", class: "comment-text", delay: 400 },
        { text: "", class: "system-text", delay: 400 },
        ...
        { text: "", class: "system-text", delay: 500 },
        { text: "> Vჱღ ვჲღჸომნ.", class: "golden-text", delay: 0 },
    ],
    bloom: [
        { text: "// =============================================================================", class: "comment-text", delay: 100 },
