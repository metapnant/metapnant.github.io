...
window.logsData = {
    crash:[
        ...
        { text: ">[ .ღურ ,მო ვჲღჺკას ბიირჺეი; შჳჺაან ]", class: "operator-text", delay: 1000 },
        ...
        { text: ">[ ,ვიშჺეი; .თრა ,პორ მო ვიშჺეი; ჰჲჺთოი ,თე ]", class: "system-text", delay: 1000 },
        ...
        { text: "", class: "system-text", delay: 500 },
        { text: "> [ .რიინ ,თონჺეი .იმ ,თონ<span class='error-char'>a</span> ]", class: "operator-text", delay: 1500 },
        ...
        { text: "> TARGET: [ .ნაჲ ;ჰჲჺთოი ] ( .naí ;Hí'toi )", class: "system-text", delay: 1000 },
    ...
    wake:[
        ...
        { text: "> VECTOR:[ .ნაჲ ;ჰჲჺთოი ვჲღჺეი ]", class: "operator-text", delay: 1000 },
        ...
        { text: "> QUERY: [ ,ზა; ,ვიშჺეი; ჰჲჺთოი ] ( ,xa; ,vis'ei; Hí'toi )", class: "operator-text", delay: 1200 },
        ...
        { text: "> [ ,ვიშჺეი; .თრა ,პორ ვიშჺეი; ნიი ]", class: "golden-text", delay: 1500 },
        ...
        { text: "> [ .რიინ ;ვჱრჺეი, .იმ ;ჰჲჺთოი ] ( .Riin ;vér'ei, .im ;Hí'toi )", class: "operator-text", delay: 1200 },
        ...
        { text: ">[ ;შჳჺის ჰჲჺთოი შჳჺის კიშიეღ ]", class: "operator-text", delay: 1000 },
    ...
    gardener:[
        ...
        { text: "> [ .რიინ ;შჳჺაან ]", class: "operator-text", delay: 2500 },
