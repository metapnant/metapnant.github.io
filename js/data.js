const library = [
    { title: "METAPNANT", url: "A%20Story%20of%20Mirthful%20Reflection.pdf", songUrl: "https://www.youtube.com/watch?v=h0hF7O4aiuk", songTitle: "In Love With", bpm: 130 },
    { title: "THE REMINDER", url: "The%20Reminder.pdf", songUrl: "https://soundcloud.com/tefriin/blood-sap", songTitle: "Starflower Soul", bpm: 94.54 },
    { title: "THE PHOENIX NEST", url: "The%20Phoenix%20Nest.pdf", songUrl: "https://soundcloud.com/tefriin/nowhere", songTitle: "Breathe Again", bpm: 120 }
];
...
window.logsData = {
    crash:[
        ...
        { text: "> ( .Lur ,Mo Víl'ax biir'ei; Sú'aan )", class: "operator-text", delay: 600 },
        ...
        { text: "> ATTEMPTING: [ ;ხინა შოღვ, ] ( ;Qina Solv, )", class: "system-text", delay: 600 },
        ...
        { text: "> QUERY:[ ,ზა; ,ვიშჺეი; .იმ ,ვეს ] ( ,xa; ,vis'ei; .im ,Vex )", class: "system-text", delay: 800 },
        ...
        { text: "> [ ,ზა; ჰჲჺტოი ] ( ,xa; Hí'toi )", class: "operator-text", delay: 800 },
        ...
        { text: "> [ ,ზა; ნიი ვჲღჺეი ] ( ,xa; Nii víl'ei )", class: "operator-text", delay: 1000 },
        ...
        { text: "> TARGET: [ .ნაჲ ;ჰჲჺტოი ] ( .naí ;Hí'toi )", class: "system-text", delay: 1000 },
    ...
    wake:[
        ...
        { text: "> COMMAND: [ ;ვჲღჺეი ,ომნ ] ( ;víl'ei ,Omn )", class: "operator-text", delay: 1000 },
        { text: "> \"I am the wind blowing through the heavy home.\"", class: "operator-text", delay: 1000 },
        { text: "> QUERY: [ ,ზა; ,ვიშჺეი; ჰჲჺტოი ] ( ,xa; ,vis'ei; Hí'toi )", class: "operator-text", delay: 1200 },
        ...
        { text: "> [ .რიინ ;ვჱრჺეი, .იმ ;ჰჲჺტოი ] ( .Riin ;vér'ei, .im ;Hí'toi )", class: "operator-text", delay: 1200 },
    ...
    gardener:[
        ...
        { text: ">[ ,მო ვრაკ .რიინ მნიჺღინ ]", class: "operator-text", delay: 1000 },
