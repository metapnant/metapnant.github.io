const library = [
    { title: "METAPNANT", url: "A%20Story%20of%20Mirthful%20Reflection.pdf"},
    { title: "THE REMINDER", url: "The%20Reminder.pdf"},
    { title: "THE PHOENIX NEST", url: "The%20Phoenix%20Nest.pdf", songUrl: "https://soundcloud.com/metapnant/nowhere", songTitle: "Timelines", bpm: 116 }
];
...
const albumTracks = [
    ...
    { title: "Final Boundaries", src: "music/05 - Final Boundaries.mp3" },
    { title: "Reborn", src: "music/06 - Reborn.mp3" }, 
    { title: "Disordered Fairness", src: "music/07 - Disordered Fairness.mp3" },
    { title: "Fear", src: "music/08 - Fear.mp3" },
    { title: "Remember", src: "music/09 - Remember.mp3" },
    { title: "My Way", src: "music/10 - My Way.mp3" },
    { title: "Distant", src: "music/11 - Distant.mp3" },
    { title: "Limerent", src: "music/12 - Limerent.mp3" },
    { title: "River of Sorrows", src: "music/13 - River of Sorrows.mp3" },
    { title: "諍", src: "music/14 - 諍.mp3" },
    { title: "Sun; Rise", src: "music/15 - Sun; Rise.mp3" },
    { title: "Starflower Soul", src: "music/16 - Starflower Soul.mp3" },
    { title: "Branches", src: "music/17 - Branches.mp3" },
    { title: "Entranced in", src: "music/18 - Entranced in.mp3" },
    { title: "Timelines", src: "music/19 - Timelines.mp3" },
    { title: "Breathe Again", src: "music/20 - Breathe Again.mp3" },
