...
window.logsData = {
    crash:[
        ...
        { text: ">[ .ღურ ,მო ვჲღჺას ბიირჺეი; შჳჺაან ]", class: "operator-text", delay: 1000 },
        { text: "> ( .lur ,mo víl'ax bıır'eı; sú'aan )", class: "operator-text", delay: 600 },
        ...
        { text: "> QUERY:[ ,ზა; ,ვიშჺეი; .იმ ,ვეს ] ( ,xa; ,vıs'eı; .ım ,vex )", class: "system-text", delay: 800 },
        ...
        { text: "> [ ,ზა; ჰჲჺტოი ] ( ,xa; hí'toı )", class: "operator-text", delay: 800 },
        ...
        { text: "> [ ,ზა; ,მიშ ] ( ,xa; ,mıs )", class: "operator-text", delay: 800 },
        { text: "> \"Am I lost?\"", class: "operator-text", delay: 600 },
        { text: "> [ ,ზა; ნიი ვჲღჺეი ] ( ,xa; nıı víl'eı )", class: "operator-text", delay: 1000 },
    ...
    echo:[
        ...
        { text: "", class: "system-text", delay: 400 },
        { text: "[ OPERATOR ]:", class: "reix-header", delay: 400 },
        { text: "> [ .ტეჾ ჲმ ,ზა; ]", class: "operator-text", delay: 1000 },
    ...
    wake:[
        ...
        { text: ">[ ,ზა; ,ვიშჺეი; ,პრე ]", class: "operator-text", delay: 1000 },
        ...
        { text: "> QUERY: [ ,ზა; ,ვიშჺეი; ჰჲჺტოი ] ( ,xa; ,vıs'eı; hí'toı )", class: "operator-text", delay: 1200 },
