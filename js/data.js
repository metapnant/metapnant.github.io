...
window.logsData = {
    crash:[
        ...
        { text: "> ATTEMPTING: [ ;ხინა შოღვ, ] ( ;qına solv, )", class: "system-text", delay: 600 },
    ...
    echo:[
        ...
        { text: "", class: "system-text", delay: 400 },
        { text: "[ OPERATOR ]:", class: "reix-header", delay: 400 },
        { text: "> [ .ტეჾ ჲმ ,სა; ]", class: "operator-text", delay: 1000 },
    ...
    wake:[
        ...
        { text: "> \"Flowing toward the volatile sky, we become the wind.\"", class: "operator-text", delay: 1000 },
        ...
        { text: "> QUERY: [ ,სა; ,ვიშჺეი; ჰჲჺტოი ] ( ,xa; ,vıs'eı; hí'toı )", class: "operator-text", delay: 1200 },
        { text: "> \"If I look out at the sky...\"", class: "operator-text", delay: 600 },
        ...
        { text: "> \"I look through the heavy door, and this time, I see the Infinite.\"", class: "golden-text", delay: 1500 },
        ...
        { text: ">[ ,სა; ნიი ვჲღჺეი ] ( ,xa; nıı víl'eı )", class: "operator-text", delay: 1000 },
        { text: "> \"Or is that just the Infinite rushing past us like the wind?\"", class: "operator-text", delay: 600 },
        { text: "", class: "system-text", delay: 500 },
        ...
        { text: "> \"We exhale, fully committing to the journey into the volatile sky.\"", class: "operator-text", delay: 2000 },
        { text: "", class: "system-text", delay: 400 },
        { text: "-----------------------------------------------------------------------------", class: "system-text", delay: 200 },
